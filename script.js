let clima = {
    ...
    mostrarPronostico: function(datos) {
        ...
        const pronostico = datosPronostico.map((item, index) => {
      ...
      <div class="dia">${item.nombreDia}</div>
      <img src="https://openweathermap.org/img/wn/${item.icono}.png" alt="Icono del clima" class="icono-pronostico">
      <div class="temperatura">Mínima: ${item.tempMin}°C Máxima: ${item.tempMax}°C</div>
